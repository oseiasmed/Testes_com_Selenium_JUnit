...
public class TesteCampoTreinamento {
	...
	public void testTextFieldDuplo(){
		dsl.escrever("elementosForm:nome", "Oséias");
		Assert.assertEquals("Oséias", dsl.obterValorCampo("elementosForm:nome"));
		dsl.escrever("elementosForm:nome", "Medeiros");
		Assert.assertEquals("Medeiros", dsl.obterValorCampo("elementosForm:nome"));
	}
